          ...
          {tododata.map((e) => (
            <div className='border-2 bg-white flex justify-between rounded pl-2 pr-4 py-1 mb-2 mt-1 text-overflow-ellipsis' key={e.id}>
              ...
              <div className='icons flex gap-2'>
                <i className="fa-solid fa-trash-can mt-2 cursor-pointer" onClick={() => handleDelete(e.id)} />
                <i className="fa-solid fa-pencil mt-2 cursor-pointer" onClick={() => handleEdit(e.id)}></i>
